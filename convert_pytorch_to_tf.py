...
import numpy as np
import torch
from transformers.models.bert import BertConfig, TFBertForPreTraining, BertForPreTraining, \
...
def convert_pt_checkpoint_to_tf(
    ...
    tf_model.save('tf_serving/2tf_model')
...
# modeling_utils.py 2718 注释掉
# --tf_dump_path tf --model_type bert --pytorch_checkpoint_path checkpoints --config_file model_hub/chinese-bert-wwm/config.json --compare_with_pt_model
